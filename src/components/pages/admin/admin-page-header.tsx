    ...
    <header className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex min-w-0 items-center gap-4">
        ...
        <div className="min-w-0">
          <h1 className="break-words text-2xl font-semibold tracking-tight text-neutral-950 dark:text-neutral-50 sm:text-3xl">
            {title}
          </h1>
          {description ? (
            <p className="mt-1 break-words text-sm leading-6 text-neutral-500 dark:text-neutral-400">
              {description}
            </p>
          ) : null}
        </div>
